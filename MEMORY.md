...
- `test/features/comments.ts` unclosed `/*` input currently throws `unterminatedBlockComment` in Swift rather than formatting to `count(*) / * ...` as upstream JS test expects.
